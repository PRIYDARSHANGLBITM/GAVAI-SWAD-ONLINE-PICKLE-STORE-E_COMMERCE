...
if($msg==3)
{
    $msgerr1="Don't try to fool me !! you are trying to access a page without login. ";
}
...
<body>
    ...
    <div class="col-sm-2 mt-5"></div>
            <div class="col-sm-4 bg-light  mt-5 shadow">
                <img src="../assets/images/admin2.png" style="height:100%;width:100%;" />
            </div>
            <div class="col-sm-4 bg-light  mt-5 shadow">
